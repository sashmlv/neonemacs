...
;; (setq eldoc-area-prefer-doc-buffer t)
;; ;; EGLOT
...
(setq lsp-typescript-update-imports-on-file-move-enabled nil)
(setq lsp-completion-provider :none)
(setq gc-cons-threshold 100000000) ;; 500mb
(setq read-process-output-max 1048576) ;; 10mb
...
;; (add-hook 'vue-mode-hook 'highlight-indentation-mode)
